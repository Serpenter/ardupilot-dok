...
const char * AP_VideoTX::band_names[] = {"A","B","E","F","R","P","L","U","O","X","1G3_A","1G3_B","3G3_A","3G3_B"};
...
const uint16_t AP_VideoTX::VIDEO_CHANNELS[AP_VideoTX::MAX_BANDS][VTX_MAX_CHANNELS] =
{
    ...
    { 5658, 5695, 5732, 5769, 5806, 5843, 5880, 5917}, /* Band R 'Race' */
    { 5653, 5693, 5733, 5773, 5813, 5853, 5893, 5933}, /* Band P */
    { 5333, 5373, 5413, 5453, 5493, 5533, 5573, 5613}, /* Band L 'Low Race' */
